    ...
    if (user) {
      authHTML = `
        <div class="d-flex align-items-center gap-2 me-md-2 position-relative">
          ${isAdmin ? '<a href="admin.html" class="nav-auth-btn" style="background: rgba(16, 185, 129, 0.15); color: #10b981 !important; border: 1px solid #10b981; padding: 4px 10px; border-radius: 6px; text-decoration: none; font-size: 0.8rem; font-weight: 700;">⚙️ Admin</a>' : ''}
